...
//    glfwWindowHint(GLFW_OPENGL_PROFILE, GLFW_OPENGL_CORE_PROFILE);
    ...
    Shader lightingShader("shaders/lightning.5.1.vertexshader", "shaders/lightning.5.1.fragmentshader");
    Shader lampShader("shaders/lamp.5.1.vertexshader", "shaders/lamp.5.1.fragmentshader");
