...
//    glfwWindowHint(GLFW_OPENGL_PROFILE, GLFW_OPENGL_CORE_PROFILE);
    ...
    Shader lightingShader("shaders/lightcast/lightning.vertexshader", "shaders/lightcast/lightning.fragmentshader");
    Shader lampShader("shaders/lightcast/lamp.vertexshader", "shaders/lightcast/lamp.fragmentshader");
...
//    glEnableVertexAttribArray(0);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //For a directional or point light
