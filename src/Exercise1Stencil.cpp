...
//    glfwWindowHint(GLFW_OPENGL_PROFILE, GLFW_OPENGL_CORE_PROFILE);
    ...
    Shader shader("shaders/stencil/model.vertexshader", "shaders/stencil/model.fragmentshader");
    Shader shaderSingleColor("shaders/stencil/model.vertexshader", "shaders/stencil/shaderSingleColor.fragmentshader");
