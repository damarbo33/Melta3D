...
//    glfwWindowHint(GLFW_OPENGL_PROFILE, GLFW_OPENGL_CORE_PROFILE);
    ...
    Shader lightingShader("shaders/lightmaps/lightning.vertexshader", "shaders/lightmaps/lightning.fragmentshader");
    Shader lampShader("shaders/lightmaps/lamp.vertexshader", "shaders/lightmaps/lamp.fragmentshader");
